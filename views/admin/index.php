        ...
        <div id="dashboard-container" class="container">
            <div id="left-container">
                <div id="panels-container">
                    ...
                    <div class="panel">
                        <div class="title">Gastos</div>
                        <div class="datum">$<?php echo number_format($stats['average-expenses'], 2)?></div>
                    ...
                    <div class="panel">
                        <div class="title">Categorías</div>
                        <div class="datum"><?php echo $stats['category-most-used']?></div>
                        <div class="description">Categorias más usada</div>
                    </div>
                    <div class="panel">
                        <div class="title">Categorías</div>
                        <div class="datum"><?php echo $stats['category-less-used']?></div>
