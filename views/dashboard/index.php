                            ...
                            <div class="total-expense">
                                <?php
                                    if($maxExpensesThisMonth === NULL){
                                        ...
                                        <span>$<?php echo number_format($maxExpensesThisMonth, 2);?></span>
                                    <?php }?>
            ...
            <div id="right-container">
                <div class="transactions-container">
                    <section class="operations-container">
                        ...
                        <button class="btn " id="">
                            <a style="color:white"  href="<?php echo constant('URL');?>expenses/create">Create nuevo gasto</a>
                        </button>
                    ...
                    <h2>Registros más recientes</h2>
                        <?php
                            ...
                            if($expenses === NULL){
                                ...
                                echo 'No hay registros de gastos.';
                            }else{
